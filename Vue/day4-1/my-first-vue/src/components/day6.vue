<template>
  <div>
    ...
    <div class="fa_table">
      <button class="addShop" @click="toJudge()">添加评论</button>
      ...
      <el-table :data="currentPageData"  style="width: 100%">
        <el-table-column label="编号" width="150">
          <template slot-scope="scope">
            ...
            <span style="margin-left: 0">{{ scope.row.id }}</span>

          </template>
        </el-table-column>
        <!--<el-table-column label="商品名称" width="150">-->
          <!--<template slot-scope="scope">-->
            <!--<span style="margin-left: 0">{{ scope.row.tmName}}</span>-->
          <!--</template>-->
        <!--</el-table-column>-->
        ...
        <el-table-column label="等级ID" width="150">
          <template slot-scope="scope">
            <span style="margin-left: 0">{{ scope.row.u_class}}</span>
          </template>
        </el-table-column>
        <el-table-column label="用户ID" width="280">
          <template slot-scope="scope">
            <span >{{ scope.row.u_mid}}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="评论时间" width="280">
          <template slot-scope="scope">
